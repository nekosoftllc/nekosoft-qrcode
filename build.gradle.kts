    ...
    publishing {
        publications {
            create<MavenPublication>("mavenJava") {
                ...
                pom {
                    name.set("NekoSoft Utils QrCode")
                    description.set("A wrapper around g0dkar's QR Code library for Kotlin for easier customization of QR Code looks")
                    url.set("https://git.nekosoft.org/nekosoft/nekosoft-qrcode")
                    licenses {
                        license {
                    ...
                    scm {
                        connection.set("scm:git:git@git.nekosoft.org:nekosoft/nekosoft-qrcode.git")
                        developerConnection.set("scm:git:git@git.nekosoft.org:nekosoft/nekosoft-qrcode.git")
                        url.set("https://git.nekosoft.org/nekosoft/nekosoft-qrcode")
                    }
                }
            }
